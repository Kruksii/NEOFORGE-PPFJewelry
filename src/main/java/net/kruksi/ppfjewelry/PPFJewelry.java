...
@Mod(PPFJewelry.MOD_ID)
public class PPFJewelry
{
    public static final String MOD_ID = "ppfjewelry";
    private static final Logger LOGGER = LogUtils.getLogger();

    public PPFJewelry(IEventBus modEventBus, ModContainer modContainer)
    {

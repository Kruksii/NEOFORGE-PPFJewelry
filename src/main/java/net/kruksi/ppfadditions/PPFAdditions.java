...
@Mod(PPFAdditions.MOD_ID)
public class PPFAdditions
{
    public static final String MOD_ID = "ppfadditions";
    private static final Logger LOGGER = LogUtils.getLogger();

    public PPFAdditions(IEventBus modEventBus, ModContainer modContainer)
    {
